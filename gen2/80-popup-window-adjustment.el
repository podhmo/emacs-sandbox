...
(progn ;; shackle
  ...
  (setq shackle-rules
        ...
        '((compilation-mode :select nil )
          ...
          ;; me
          ("\\`\\*[Aa]nything.*?\\*\\'" :regexp t :size 0.3 :align below)
          ("*quickrun*" :select nil :size 0.3 :align below)
          ("\\*Async Shell.*\\*" :regexp t :select nil :size 0.3 :align below)
          ("*Shell Command Output*" :select nil :size 0.3 :align below)
          ))
  (shackle-mode 1)
